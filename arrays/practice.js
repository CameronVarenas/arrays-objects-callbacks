...
var user2 = {
  name: 'Tommy Hillary',
  email: 'tom.hillary@devmounta.in',
  password: 'tomh1974',
  username: 'amtom'
}
  
var user3 = {
  name: 'Hingle McCringle',
  email: 'hingle.mccringle@devmounta.in',
  password: 'HillbillyHingleMcCringleBerry',
  username: 'HingleMcCringle'
}

var user4 = {
  name: 'Revicm Kram',
  email: 'revicm.kram@devmounta.in',
  password: 'AyyyLmao',
  username: 'ReViCmKrAm'
}
